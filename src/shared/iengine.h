...
extern void draw_text(const char *str, int left, int top, int r = 255, int g = 255, int b = 255, int a = 255, int cursor = -1);
...
extern bool bounce(physent *d, float secs, float elasticity = 0.8f, float waterfric = 0.5f);
