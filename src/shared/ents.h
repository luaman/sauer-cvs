...
enum { ANIM_DEAD = 0, ANIM_DYING, ANIM_IDLE, ANIM_FORWARD, ANIM_BACKWARD, ANIM_LEFT, ANIM_RIGHT, ANIM_PUNCH, ANIM_SHOOT, ANIM_PAIN, ANIM_JUMP, ANIM_SINK, ANIM_SWIM, ANIM_EDIT, ANIM_LAG, ANIM_TAUNT, ANIM_WIN, ANIM_LOSE, ANIM_VWEP, ANIM_POWERUP, ANIM_GUNSHOOT, ANIM_GUNIDLE, ANIM_MAPMODEL, ANIM_TRIGGER, NUMANIMS };
