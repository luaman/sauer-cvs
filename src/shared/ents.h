...
#define ET_EMPTY 0
#define ET_LIGHT 1              
#define ET_MAPMODEL 16                          // legacy constant for compatability with older mapfiles
...
enum { ANIM_DYING = 0, ANIM_DEAD, ANIM_PAIN, ANIM_IDLE, ANIM_IDLE_ATTACK, ANIM_RUN, ANIM_RUN_ATTACK, ANIM_EDIT, ANIM_LAG, ANIM_JUMP, ANIM_JUMP_ATTACK, ANIM_GUNSHOOT, ANIM_GUNIDLE, ANIM_MAPMODEL };
