...
struct fpsclient : igameclient
{
    ...
    void drawhudmodel(int anim, float speed, int base)
    {
        ...
        rendermodel(color, dir, hudgunnames[player1->gunselect], anim, 0, 0, player1->o.x, player1->o.y, player1->o.z, player1->yaw+90, player1->pitch, false, speed, base, NULL, false);
    };
