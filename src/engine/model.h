...
struct model
{
    ...
    model() : shader(0), spec(1.0f), ambient(0.3f), alphatest(0.9f), alphablend(true), collide(true), cullface(true), shadow(true), scale(1.0f), translate(0, 0, 0), spheretree(0), bbcenter(0, 0, 0), bbradius(0, 0, 0), eyeheight(0.9f), collideradius(0), collideheight(0), envmap(NULL), batch(-1) {}
