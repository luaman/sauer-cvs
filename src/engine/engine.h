...
extern void calcvert(cube &c, int x, int y, int z, int size, svec &vert, int i, bool solid = false);
extern void calcverts(cube &c, int x, int y, int z, int size, svec *verts, bool *usefaces, int *vertused, bool lodcube);
