        ...
        if(!occluded || oe->query)
        {
            ...
            loopv(oe->mapmodels)
            {
                ...
                else if(e.visible)
                {
                    ...
                    rendermodel(e.color, e.dir, mmi.name, ANIM_MAPMODEL, 0, e.attr4, e.o.x, e.o.y, e.o.z+mmi.zoff+e.attr3, (float)((e.attr1+7)-(e.attr1+7)%15), 0, false, 10.0f, 0, NULL, MDL_CULL_VFC | MDL_CULL_DIST);
                    e.visible = false;
                };
            };
            if(occluded)
